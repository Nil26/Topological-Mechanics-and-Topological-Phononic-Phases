...
\title{\textbf{Topological Mechanics \\and Topological Phononic Phases}} % Title

\author{\textsc{Shang Zhang} % Author
\\{\textit{University of Michigan}}} % Institution
...
\hspace*{3,6mm}\textit{Keywords:} topological mechanics, floppy modes , isostatic % Keywords
...
\centering
\includegraphics[width=0.8\textwidth]{nphys2835-f1.jpg}
\caption{SSH Model}
\end{figure}
...
\section*{Deformed Kagome Lattice Model}
...
\bibliography{TermPaper_ref.bib}
